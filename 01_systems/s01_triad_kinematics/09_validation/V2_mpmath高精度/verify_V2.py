...
#
# 算法联盟 · openuft · 30_V_验证_verification/V2
...
SRC = str(PROJECT_ROOT / "01_systems/s01_triad_kinematics/07_computation/src")
if SRC not in sys.path:
    sys.path.insert(0, SRC)

import mpmath as mp  # noqa: E402
from triad_uft import triad, physics  # noqa: E402
