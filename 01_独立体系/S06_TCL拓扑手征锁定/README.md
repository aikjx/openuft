...
> ⚠️ **勘误（2026-09-26，S06-C0003）**：`02_基础公设/source_chapter.md` 是跨体系原著的**只读原始留档（provenance 锁定，不可改）**，其中边界态计数「12 类 / 3×2=6 / T6=36」自相矛盾且与标准模型真实手征谱（单代 15 个左手 Weyl、三代 45）不符，已证伪并降 conjecture。详见 [02_基础公设/postulates.md](02_基础公设/postulates.md) §5 缺陷3 与 [11_证伪与反例/边界态计数矛盾记录.md](11_证伪与反例/边界态计数矛盾记录.md)；代数维数 256（C0001/C0002）正确但不为计数背书。
