...
for sid in layout['systems']+['新体系模板']:
    base=ROOT/'01_独立体系'/sid
...
src=Path(__file__).resolve();dst=ROOT/'90_历史归档/迁移记录/20260907_独立体系'/源码.name
