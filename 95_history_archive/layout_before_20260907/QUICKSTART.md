...
| 6 | `FAQ.md` | 50 个常见问题 |
| 7 | `40_A_精算_audit/A4_诚实声明OpenProblems/开放问题清单_L0-L2.md` | **OPEN 问题清单** ← 必读 |
...
- `70_source_code/triad_uft/` → 工业级 Python 包
...
- ⚠️ 读 [40_A_精算_audit/A4_诚实声明OpenProblems/](40_A_精算_audit/A4_诚实声明OpenProblems/开放问题清单_L0-L2.md)
