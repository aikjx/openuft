...
```bash
# 1. 符号证明
python src/triad_uft/verify/verify_sympy.py

# 2. 高精度
python src/triad_uft/verify/verify_mpmath.py --dps=50

# 3. 实验对标
python src/triad_uft/verify/verify_pdg.py
python src/triad_uft/verify/verify_ligo.py
python src/triad_uft/verify/verify_planck.py
