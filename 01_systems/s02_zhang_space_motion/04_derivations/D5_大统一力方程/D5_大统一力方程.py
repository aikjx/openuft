# D5_大统一力方程.py — 复算张祥前统一力框架核心关系
#
# 算法联盟 · openuft · 10_D_求导_derivation/D5
...
SRC = str(PROJECT_ROOT / "01_systems/s02_zhang_space_motion/07_computation/src")
if SRC not in sys.path:
    sys.path.insert(0, SRC)

import zhang_force as derivations  # noqa: E402


def main():
    print("=" * 70)
    print(" D5 大统一力方程（张祥前）· 核心关系复算")
    print("=" * 70)

    for vf in [0.1, 0.3, 0.6, 0.9]:
        r = derivations.zhang_unified_force(v_frac=vf)
        print("\n v = {:.2f} c".format(vf))
