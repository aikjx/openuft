...
**[REF002]** Einstein A. Die Grundlage der allgemeinen Relativitätstheorie[J]. Annalen der Physik, 1916, 354(7): 769-822. DOI: 10.1002/andp.19163540702.

核实范围：已核对 DOI 注册元数据；不表示审查正文。 [来源](https://doi.org/10.1002/andp.19163540702)。
...
**[REF004]** Born M., Jordan P. Zur Quantenmechanik[J]. Zeitschrift f�r Physik, 1925, 34(1): 858-888. DOI: 10.1007/bf01328531.

核实范围：已核对 DOI 注册元数据；不表示审查正文。 [来源](https://doi.org/10.1007/bf01328531)。
...
**[REF008]** Weyl Hermann. Elektron und Gravitation. I[J]. Zeitschrift f�r Physik, 1929, 56(5-6): 330-352. DOI: 10.1007/bf01339504.

核实范围：已核对 DOI 注册元数据；不表示审查正文。 [来源](https://doi.org/10.1007/bf01339504)。

**[REF009]** Yang C. N., Mills R. L. Conservation of Isotopic Spin and Isotopic Gauge Invariance[J]. Physical Review, 1954, 96(1): 191-195. DOI: 10.1103/physrev.96.191.

核实范围：已核对 DOI 注册元数据；不表示审查正文。 [来源](https://doi.org/10.1103/physrev.96.191)。
...
**[REF012]** Weinberg Steven. A Model of Leptons[J]. Physical Review Letters, 1967, 19(21): 1264-1266. DOI: 10.1103/physrevlett.19.1264.

核实范围：已核对 DOI 注册元数据；不表示审查正文。 [来源](https://doi.org/10.1103/physrevlett.19.1264)。
...
**[REF015]** Fritzsch Harald, Minkowski Peter. Unified interactions of leptons and hadrons[J]. Annals of Physics, 1975, 93(1-2): 193-266. DOI: 10.1016/0003-4916(75)90211-0.

核实范围：已核对 DOI 注册元数据；不表示审查正文。 [来源](https://doi.org/10.1016/0003-4916(75)90211-0)。

**[REF016]** M. B. Green, J. H. Schwarz. Anomaly Cancellation in Supersymmetric D=10 Gauge Theory[J]. Phys. Lett., 1984, B149: 117.

核实范围：按原有条目规范化；未独立核实版次、完整页码或出版元数据。

**[REF017]** Witten Edward. String theory dynamics in various dimensions[J]. Nuclear Physics B, 1995, 443(1-2): 85-126. DOI: 10.1016/0550-3213(95)00158-o.

核实范围：已核对 DOI 注册元数据；不表示审查正文。 [来源](https://doi.org/10.1016/0550-3213(95)00158-o)。
...
**[REF020]** Sorkin Rafael D. Causal Sets: Discrete Gravity[J]. Series of the Centro De Estudios Científicos, 年份待核: 305-327. DOI: 10.1007/0-387-24992-3_7.

核实范围：已核对 DOI 注册元数据；不表示审查正文。 [来源](https://doi.org/10.1007/0-387-24992-3_7)。

**[REF021]** Guth Alan H. Inflationary universe: A possible solution to the horizon and flatness problems[J]. Physical Review D, 1981, 23(2): 347-356. DOI: 10.1103/physrevd.23.347.

核实范围：已核对 DOI 注册元数据；不表示审查正文。 [来源](https://doi.org/10.1103/physrevd.23.347)。

**[REF022]** A. G. Riess et al. Observational Evidence from Supernovae for an Accelerating Universe and a Cosmological Constant[J]. AJ, 1998, 116: 1009.
