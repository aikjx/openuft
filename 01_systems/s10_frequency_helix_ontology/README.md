...
- [S01 螺旋三重奏与谱几何](../s01_triad_kinematics/README.md)：借用 Frenet/曲率挠率数学语言；数学成立不认证振动本体。
- [S12 空间光速螺旋统一体系](../s12_light_speed_helix/README.md)：共用数学骨架 `√(κ²+τ²) = ω/c`，但本体不同（振动 vs 空间运动）、对 c 的约束不同（`v ≤ c` 上限 vs `v ≡ c` 恒等）。两体系互不认证。
