...
from triad_uft import proofs, triad, derivations  # noqa: E402
...
def main():
    dps = 50
    print("=" * 88)
    print(" openuft · triad_uft 验证引擎  v4.1.0")
    ...
    print(" 暗物质/暗能量/强相互作用精确描述）仍为 OPEN（见 40_A_精算_audit/A4）。")
    print("=" * 88)
