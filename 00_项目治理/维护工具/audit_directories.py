...
def main():
    ...
    roles={'00_项目治理':'项目规则、索引及审计','01_独立体系':'按基础前提独立管理体系','02_共享基础':'共同方法、常数与基准','03_跨体系研究':'显式跨体系比较及组合','04_公共成果':'跨体系综述与公共展示','05_全球研究':'全球文献覆盖、翻译及协作','90_历史归档':'历史布局及迁移证据','99_待整理资料':'归属未定的输入','.github':'协作平台配置'}
