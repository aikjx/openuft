...
| `AI科技星_全维三重奏定理完整严格证明.md` ★ | `20_P_证明_proof/P3_归纳闭合_R9/完整严格证明.md` |
| `AI科技星_绝热三重奏定理.md` ★ | `20_P_证明_proof/P4_绝热三重奏_R10/绝热与纯圆周精确.md` |
| `AI科技星_全维三重奏定理证明攻坚.md` | `20_P_证明_proof/P3_归纳闭合_R9/证明攻坚.md` |
| `AI科技星_全维三重奏定理谱理论证明.md` | `20_P_证明_proof/P6_谱理论框架_R7R8/谱理论证明.md` |
| `AI科技星_全维三重奏最高权限精算.md` | `20_P_证明_proof/P3_归纳闭合_R9/最高权限精算.md` |
| `AI科技星_全维三重奏终极报告.md` | `20_P_证明_proof/P1_螺旋三重奏_TS1/终极报告.md` |
| `AI科技星_全维三重奏研究总报告.md` | `20_P_证明_proof/P1_螺旋三重奏_TS1/研究总报告.md` |
...
| 原文件 | 目标位置 |
|---|---|
| `AI科技星_统一场论严格审计与精算分析.md` | `40_A_精算_audit/A1_误差预算/严格审计与精算.md` |
| `统一场论知识体系整理.md` | `40_A_精算_audit/A5_证据分层标注/知识体系整理.md` |
...
| 原文件 | 目标位置 |
|---|---|
| `AI科技星_全维统一场论终极总报告_v2.md` | `90_paper_论文/终极报告系列/v2_20260905.md` |
| `AI科技星_全维统一场论终极总报告_v3.md` | `90_paper_论文/终极报告系列/v3_20260905.md` |
| `AI科技星_全维统一场论终极总报告_v4.md` | `90_paper_论文/终极报告系列/v4_20260906.md` |
| `AI科技星_全维统一场论终极总报告_v5.md` | `90_paper_论文/终极报告系列/v5_20260906.md` |
| **`AI科技星_全维统一场论终极总报告_v6.md`** ★ | `90_paper_论文/终极报告系列/v6_20260906_FINAL.md` |
| `全维统一场论_全维度修订版.md` | `90_paper_论文/全维修订版v2/全维度修订v2.md` |
| `AI科技星_全维统一场论_v3.md` | `90_paper_论文/求导证明v3/求导证明v3.md` |
| `统一场论知识体系整理.md` | `90_paper_论文/知识体系整理/知识体系整理.md` |
| `AI科技星_全维三重奏大统一分析.md` | `90_paper_论文/综述修订/大统一分析.md` |
...
| `大统一方程与四力统一全集_AI科技星最高权限版.md` | `95_history_archive/大统一方程全集.md` |
...
| 原文件/路径 | 目标位置 |
|---|---|
| `三重奏统一场/`, `测试/`, `examples/`（如已存在） | `70_source_code/三重奏统一场/`, `测试/`, `examples/` |
...
cp -n "$SRC/AI科技星_全维三重奏定理完整严格证明.md" "$DST/20_P_证明_proof/P3_归纳闭合_R9/完整严格证明.md"

mkdir -p "$DST/20_P_证明_proof/P4_绝热三重奏_R10"
cp -n "$SRC/AI科技星_绝热三重奏定理.md" "$DST/20_P_证明_proof/P4_绝热三重奏_R10/绝热与纯圆周精确.md"
...
for v in 2 3 4 5 6; do
  cp -n "$SRC/AI科技星_全维统一场论终极总报告_v$v.md" "$DST/90_paper_论文/终极报告系列/v${v}_20260906.md"
done
...
1. **运行** `python 三重奏统一场/audit_report.py` 验证完整性
