...
### 备选方案
1. `alg_uft_unified` (AI科技星·统一UFT) — 内部研发代号
2. `UFT2026` (年度+主题)
3. `unified-field` (通用名)
4. `三重奏统一场` (以三重奏为核心)
5. **`openuft`** (开源 + UFT)
...
### 选择 openuft 的理由
| 标准 | openuft | alg_uft_unified | UFT2026 | unified-field | 三重奏统一场 |
|---|---|---|---|---|---|
| 开源友好 | ★★★★★ | ★★☆☆☆ | ★★★☆☆ | ★★★★☆ | ★★★☆☆ |
| 主题清晰 | ★★★★★ | ★★★☆☆ | ★★★★☆ | ★★★★★ | ★★★★☆ |
| SEO 友好 | ★★★★★ | ★☆☆☆☆ | ★★★☆☆ | ★★★☆☆ | ★★★☆☆ |
...
### 妥协
通过 `CITATION.cff` 软性要求引用。通过诚实声明（`A4_诚实声明与开放问题`）软性要求不宣称"万有理论"。
...
## ADR-009 · 作者署名统一切换为「AI科技星」

**日期**：2026-09-06
**状态**：✅ 已采纳

### 决策
项目作者署名从「莫国子（Guozi Mo）/ AI科技星」统一切换为 **AI科技星**。

### 旧名清理
- `莫国子` → `AI科技星`（已批量替换 60+ 文件）
- `Guozi Mo` / `Guozi` → `AI科技星`
- `AI科技星` → `AI科技星`
- `ROOT`（孤立使用）→ `AI科技星`

### 保留
- 「**AI科技星**」作为**研究组织名**（方法论传承标识）
- LICENSE 中的双署名：`Copyright (c) 2026 AI科技星`
...
### 选择 AI科技星的理由
1. **统一性**：原「莫国子」「AI科技星」混合使用造成文件标记混乱
2. **品牌化**：「AI科技星」更易记、可用作商标
3. **国际化**：AI科技星 与中文署名 1:1 对应，便于双语发布
4. **传承性**：组织名保留「AI科技星」作为方法论溯源
...
## ADR-008 · 三重奏统一场 包独立（暂不在本仓库）

**日期**：2026-09-06
**状态**：🟡 暂定

### 决策
`三重奏统一场` 工业级 Python 包**暂时**不纳入 openuft 仓库，原因：
1. 包代码位于 `D:/a10/aikjx/code/` 另一位置
2. 体积较大（数百 KB）
3. 测试套件独立维护

### 长期计划
- v4.x 系列：在 `70_source_code/` 添加 `三重奏统一场/` 子模块（git submodule）
- v5.0.0：完全整合进 openuft 包

### 当前 `70_source_code/` 内容
目前为空目录，等待 三重奏统一场 代码迁移。
